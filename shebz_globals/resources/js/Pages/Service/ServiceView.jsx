                        ...
                        >
                            ...
                            <div
                                className="
                                    ...
                                    mb-6 bg-gray-50 rounded-xl overflow-hidden
                                "
                            >
                                {service?.icon ? (
                                    <img
                            ...
                            {/* DESCRIPTION */}
                            <p className="text-gray-600 text-sm text-center mb-5 line-clamp-3">
                                {service?.description
            ...
            <section className="mt-16 bg-gray-50 rounded-xl p-6 md:p-10 flex justify-center">
                <div className="max-w-3xl w-full text-center">
                    ...
                    <div className="space-y-4 text-gray-700">
                        <p>
                            <strong>21+ years</strong> of global OHS experience
                            across industries.
                        </p>
                        <p>
                        ...
                        <p>
                            Access to international safety technology networks
                            and partners.
                        </p>
                        <p>
                            <strong>
                        ...
                        <p>
                            Collaboration-friendly model with manufacturers,
                            developers, and trainers worldwide.
                        </p>
                    </div>
